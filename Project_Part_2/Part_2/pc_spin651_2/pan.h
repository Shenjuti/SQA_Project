...
#define PanSource	"Reservation.pml"
...
#define _nstates2	7	/* Reserve2 */
#define minseq2	19
#define maxseq2	24
#define _endstate2	6

#define _nstates1	7	/* Reserve1 */
#define minseq1	13
#define maxseq1	18
#define _endstate1	6

#define _nstates0	14	/* Customer */
#define minseq0	0
#define maxseq0	12
...
#define PReserve2	((P2 *)_this)
typedef struct P2 { /* Reserve2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, out) - 1*sizeof(uchar))

#define PReserve1	((P1 *)_this)
typedef struct P1 { /* Reserve1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
